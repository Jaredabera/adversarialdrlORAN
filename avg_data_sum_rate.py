...
log_file_path = "D:/DRL based Resource Allocation in/drl_ra_adv_attack/ResourceAllocatorSaboteur/agent.log"
...
plt.title('Average Data Sum Rate in [Mbps] per 1000 Timeslots Group')
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('Average Reward per 1000 Timeslots Group')
plt.legend()
plt.grid(True)
plt.show()
